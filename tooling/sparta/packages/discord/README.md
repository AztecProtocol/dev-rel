...
| `/mod`      | `add-validator`| Add a validator to the validator set                                                             | `username` (optional): Discord username of the operator<br>`user-id` (optional): Discord ID of the operator<br>`validator-address` (required): The validator address to add |
| `/mod`      | `add-multiple` | Add multiple validators to one operator                                                          | `username` (optional): Discord username of the operator<br>`user-id` (optional): Discord ID of the operator<br>`validator-addresses` (required): Comma-separated list of validator addresses |
