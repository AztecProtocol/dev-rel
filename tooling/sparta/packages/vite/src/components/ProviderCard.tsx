...
function ProviderCard({
	...
	return (
        ...
        ${
			disabled
				? "opacity-80"
				: "hover:shadow-card-hover transform hover:-translate-y-1"
		}
      ...
      `}
		>
			...
			<p className="text-gray-600 mb-6 text-center min-h-[4rem] text-base">
				{description}
			</p>
			<div className="text-center mt-8">{renderSelectButton()}</div>
		</div>
	);
}
