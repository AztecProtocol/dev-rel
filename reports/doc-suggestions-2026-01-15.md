...
Generated: 2026-01-15T03:41:45.580Z
...
|--------------|-------------------|--------|
| `docs/network_versioned_docs/version-v2.1.4/reference/glossary.md` | `yarn-project/sequencer-client/src/sequencer/sequencer.ts` | PR #19541 - no user-facing changes |
| `docs/docs-network/operators/reference/cli-reference.md` | `yarn-project/aztec/src/cli/cli.ts` | PR #19261 - no user-facing changes |
