...
import PrivateTokenContractAbiJson from '../contracts/private_token_contract/target/PrivateToken.json' assert { type: 'json' };
...
export class PrivateTokenContract extends ContractBase {
  ...
  public static deploy(rpc: AztecRPC, initial_supply: FieldLike, owner: FieldLike) {
    return new DeployMethod<PrivateTokenContract>(Point.ZERO, rpc, PrivateTokenContractAbi, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKey(rpc: AztecRPC, publicKey: PublicKey, initial_supply: FieldLike, owner: FieldLike) {
    return new DeployMethod<PrivateTokenContract>(publicKey, rpc, PrivateTokenContractAbi, Array.from(arguments).slice(2));
  }
